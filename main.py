# ==========================================
#  家計簿の作成
# 以前個人的に作成したものをポートフォリオ用に新たに作製したものとなります。
...
# フローチャートは別ファイル(mdファイル)に記載しています。以降現れるstepとはフローチャートに記載されている数字と対応しています。
# ==========================================
...
# 8. 残高の自動計算
# 残高の計算を自動で行っています。
# 支出を選択した場合は入力した金額を引き算、収入を選択した場合には足し算、振替を選択した場合には出金元を引き算、入金先を足し算しております。
# ==========================================
...
# サイドバーにおける新規データの入力を行っております。日付、アカウント、種別、大分類、詳細項目、品目、単価、数量、税区分、税率を入力するフォームです。大分類、詳細項目以外は決まったリストから選択するselectboxやradio、あるいは手入力のtext_inputやnumber_inputを使っております。大分類、詳細項目は決まったリストに加えて新規入力の欄を追加しており、
